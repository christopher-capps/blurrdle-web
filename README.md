...
Note: This is the server-side code. To actually play Blurrdle, you'll want to download and run the [Java CLI client.](https://github.com/christopher-capps/blurrdle-client) or try the web app at [Blurrdle.com](https://blurrdle.com)
